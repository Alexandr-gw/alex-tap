...
export type NotificationDeliveryStatus = 'NOT_SENT' | 'SCHEDULED' | 'SENT' | 'FAILED' | 'CANCELED' | 'NOT_APPLICABLE';
...
export type ReminderSummaryDto = {
    type: ReminderType;
    status: Extract<NotificationDeliveryStatus, 'SCHEDULED' | 'SENT' | 'FAILED' | 'CANCELED' | 'NOT_APPLICABLE'>;
