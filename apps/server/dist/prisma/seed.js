...
async function main() {
    ...
    await prisma.task.create({
        data: { companyId: company.id, jobId: job1.id, assigneeWorkerId: w1.id, status: client_1.TaskStatus.OPEN, title: "Bring eco supplies", notes: "No bleach", dueAt: new Date(now.getTime() + 45 * 60 * 1000) }
    });
