    ...
    if (isLoading) {
        return (
            <div className="overflow-hidden rounded-2xl border bg-white shadow-sm">
                <div className="p-4 text-sm text-slate-500">Loading clients...</div>
            </div>
        );
    }
                        ...
                        {items.map((client) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-3 text-slate-700">{client.phone || "N/A"}</td>
                                    <td className="px-4 py-3 text-slate-700">{client.email || "N/A"}</td>
